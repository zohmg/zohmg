...
% import.
The Zohmg import component concists of a framework which enables the user to
...
master thesis. The following sections will discuss selected tools and their
impact on design and implementation choices for the Zohmg system. The last
section will describe the scope of the thesis.
...
community, codebase, documentation, stability etc. HBase is also tightly coupled
...
more even utilization of the cluster. Since Zohmg only supports time-series,
each query has to be made over a time range.
...
solve. This restriction was made because of keeping the implementation simple,
and more general.
...
The last section describes the scope of the thesis.
