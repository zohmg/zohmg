...
Once a thourough understanding of the problem scope and its theoretical solutian
...
Also a lot of related and surronding, possibly useful, concepts were studied;
although some of these never made it to the final solution.
\cite{pig,mapreducemerge}
...
to import, store, and exporte data, a query language and sub-components for
query analyzation. The intended tasks for these components were to identify the
