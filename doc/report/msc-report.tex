...
Modelling OLAP cubes can be done in different ways, using different techniques.
...
One new techniques which can be used for OLAP data warehouses include Google's
BigTable, which is a distributed column-oriented schema-less database.

Google's MapReduce is a new technique for distributed parallel computations.
