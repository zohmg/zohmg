...
This chapter will serve as an introduction to various concepts in data
warehousing.
...
\section{Data Warehouse implementations}
...
The cube is typically modelled in a relational database with fact tables
and dimension tables, upon which the system performs joins to extract data.
\cite{olap_solutions}
