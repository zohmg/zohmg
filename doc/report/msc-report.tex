...
\title{OHM -- OHM HBase Masseuse [DRAFT]}
...
a large scale data warehouse for time-series based log-like data sources.
...
The user writes MapReduce programs which imports log-like data to the data
store.

After the data is imported a metadata scanner is run which creates metadata
...
When data is exchanged between OHM and the user either
