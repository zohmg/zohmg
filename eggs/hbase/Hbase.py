...
class get_result:
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (TCell, TCell.thrift_spec), None, ), # 0
    (1, TType.STRUCT, 'io', (IOError, IOError.thrift_spec), None, ), # 1
    (2, TType.STRUCT, 'nf', (NotFound, NotFound.thrift_spec), None, ), # 2
  )
...
class getRow_result:
  ...
  thrift_spec = (
    (0, TType.STRUCT, 'success', (TRowResult, TRowResult.thrift_spec), None, ), # 0
    (1, TType.STRUCT, 'io', (IOError, IOError.thrift_spec), None, ), # 1
  )
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i92 in xrange(_size88):
            _elem93 = BatchMutation()
            _elem93.read(iprot)
            self.rowBatches.append(_elem93)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class mutateRowsTs_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i99 in xrange(_size95):
            _elem100 = BatchMutation()
            _elem100.read(iprot)
            self.rowBatches.append(_elem100)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 3:
  ...
  def write(self, oprot):
    ...
    if self.rowBatches != None:
      oprot.writeFieldBegin('rowBatches', TType.LIST, 2)
      oprot.writeListBegin(TType.STRUCT, len(self.rowBatches))
      for iter101 in self.rowBatches:
        iter101.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.timestamp != None:
