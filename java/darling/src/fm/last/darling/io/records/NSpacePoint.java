...
public class NSpacePoint extends org.apache.hadoop.record.Record {
  ...
  static {
    ...
    _rio_recTypeInfo.addField("dimensions", new org.apache.hadoop.record.meta.MapTypeID(org.apache.hadoop.record.meta.TypeID.StringTypeID, org.apache.hadoop.record.meta.TypeID.StringTypeID));
  ...
  public NSpacePoint(
    ...
    final java.util.TreeMap<String,String> dimensions,
    final String unit) {
